...
nearest you. (Record the region that you choose, e.g., `us-east-1`; you will
need to supply it to your app in the next Phase.) You will run into an error if
the name is already taken, so be sure to choose a unique name. Including your
initials and the name of the app that will be using the bucket in the bucket's
name can help, e.g., `<your-initials>-aws-mern-twitter`.
